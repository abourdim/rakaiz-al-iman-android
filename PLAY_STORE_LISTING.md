# Play Store listing — Rakaiz al-Iman (ركائز الإيمان بين العقل والقلب)
...
- **Package name**: `org.workshopdiy.rakaizaliman`
...
```
كتاب "ركائز الإيمان بين العقل والقلب" تطبيق تفاعلي — للشيخ محمد الغزالي
```

### Full description (≤4000 chars)
```
📖 ركائز الإيمان بين العقل والقلب — تطبيق تفاعلي

تطبيق تفاعلي ثلاثي اللغة (عربي/إنجليزي/فرنسي) مستوحى من كتاب "ركائز الإيمان بين العقل والقلب" للشيخ محمد الغزالي رحمه الله (1917–1996).
...
• كتاب "ركائز الإيمان بين العقل والقلب" — الشيخ محمد الغزالي
...
### App name
```
Rakaiz al-Iman — Pillars of Faith
```

### Short description
```
"Pillars of Faith" — interactive trilingual app by Sheikh al-Ghazali
```
...
Interactive trilingual app (Arabic / English / French) based on the book "Pillars of Faith" by Sheikh Mohammed al-Ghazali (1917–1996).
...
• "Pillars of Faith" — Sheikh Mohammed al-Ghazali
...
### App name
```
Rakaiz al-Iman — Rakaiz al-Iman
```

### Short description
```
« Pillars of Faith » — application trilingue par Cheikh al-Ghazali
```
...
Application interactive trilingue (arabe / anglais / français) inspirée du livre « Pillars of Faith » du Cheikh Mohammed al-Ghazali (1917–1996).
...
• « Pillars of Faith » — Cheikh Mohammed al-Ghazali
...
```
Privacy Policy — Rakaiz al-Iman
Last updated: 2026-04-26

The Rakaiz al-Iman app does not collect, store, transmit, or share any personal
